<script lang="ts">
    ...
    <div class="min-h-screen bg-gray-50">
      <!-- Left Sidebar -->
      <nav 
        class="fixed left-0 top-0 h-full bg-[#3598db] text-white p-12 flex flex-col {sidebarTransition}"
        style="width: {sidebarWidth};"
        on:mouseenter={toggleSidebar}
        on:mouseleave={toggleSidebar}
      >
        <div class="flex items-center mb-8 mt-16">
          <img src="/Colla-TripLogo-rem.png" alt="Logo" class="w-12 h-20">
          {#if sidebarExtended}
