...
<div class="min-h-screen bg-gray-50">
  ...
  >
    <div class="space-y-8 mt-40">
      <!-- Create Trip Link -->
      <div class="bg-[#85e9eb] text-cyan rounded-full p-2 shadow-lg hover:shadow-xl hover:scale-105 transition-all flex items-center justify-center">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-label="Create Trip">
          ...
          <a href="/create-trip" class="flex items-center p-3 hover:bg-blue-600 rounded-lg transition-colors"></a>
        </svg>
      </div>
      <a href="/create-trip" class="flex items-center p-3 hover:bg-blue-600 rounded-lg transition-colors">
