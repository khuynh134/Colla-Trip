...
<div class="min-h-screen bg-gray-50">
  ...
  >
    ...
    <!-- Create Trip Link -->
<a href="/create-trip" class="flex items-center justify-center p-3 hover:bg-blue-600 rounded-lg transition-colors">
    <div class="bg-[#85e9eb] text-cyan rounded-full p-1.5 shadow-lg hover:shadow-xl hover:scale-105 transition-all">
