...
<div class="min-h-screen bg-gray-50">
  ...
  >
    <div class="space-y-8 mt-40">
      <!-- Create Trip Link -->
<a href="/create-trip" class="flex items-center p-2 hover:bg-blue-600 rounded-lg transition-colors">
    <div class="bg-[#85e9eb] text-cyan rounded-full p-1 shadow-lg hover:shadow-xl hover:scale-105 transition-all ">
