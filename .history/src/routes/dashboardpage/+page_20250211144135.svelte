...
<div class="min-h-screen bg-gray-50">
  ...
  <div 
  class="fixed left-0 top-0 h-full bg-white shadow-lg transform transition-transform duration-300 ease-in-out {createFormOpen ? 'translate-x-[80px]' : 'translate-x-[-24rem]'} overflow-y-auto z-50"
  style="width: 24rem;" 
>
    <div class="p-6">
      <!-- Form Header -->
