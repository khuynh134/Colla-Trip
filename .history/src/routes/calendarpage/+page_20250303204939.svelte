  ...
  <div class="min-h-screen bg-gray-50">
    ...
    >
      <div class="px-4 sm:px-8">
        ...
        <!-- Month Label -->
        <div class="mb-6 text-xl font-semibold">{currentMonthLabel}</div>
  <!-- Calendar Card -->
<Card class="p-4 sm:p-6 shadow-lg mb-8 max-w-5xl mx-auto w-full">
    <!-- Month View -->
    ...
    {/if}
        ...
        <!-- Event Color Legend -->
        <Card class="p-4 sm:p-6 shadow-lg mx-auto mb-8">
