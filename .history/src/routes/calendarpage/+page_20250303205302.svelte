...
<div class="min-h-screen bg-gray-50">
    ...
    <div class="transition-all duration-500 ease-in-out" style="margin-left: {sidebarWidth};">
        <div class="px-4 sm:px-8">
            ...
            <div class="flex justify-center items-start gap-x-12 max-w-7xl mx-auto w-full">
                
                <!-- Calendar -->
                <Card class="p-4 sm:p-6 shadow-lg w-3/4">
                    ...
                    {#if currentView === 'month'}
                        <div class="grid grid-cols-7 gap-px bg-gray-200">
                            ...
                            {#each calendarDays as { date, isCurrentMonth }}
                                <div class="min-h-24 p-1 bg-white border border-gray-300 text-center
                ...
                <!-- Event Legend -->
                <Card class="p-4 sm:p-6 shadow-lg w-1/4">
                    ...
                    <div class="flex flex-col gap-4">
                        {#each [
                            ...
                            <div class="flex items-center">
                                <div class="w-4 h-4 rounded mr-2" style="background-color: {eventType.color};"></div>
