<script lang="ts">
  ...
  <!-- Main container for calendar and event legend -->
<div class="flex justify-center items-start gap-x-8 max-w-6xl mx-auto w-full">
  <!-- Calendar Section -->
  <Card class="p-4 sm:p-6 shadow-lg mb-8 w-3/4">
    <!-- Month View -->
    {#if currentView === 'month'}
      <div class="grid grid-cols-7 gap-px bg-gray-200">
        ...
        {#each calendarDays as { date, isCurrentMonth }}
          <div 
            class="min-h-24 p-1 bg-white border border-gray-300 text-center
  ...
  <!-- Event Color Legend (Right Side) -->
  <Card class="p-4 sm:p-6 shadow-lg mb-8 w-1/4">
