...
<!-- Changed from sticky top-0 to relative and adjusted z-index -->
<div class="bg-gradient-to-r from-indigo-600 to-blue-500 text-white py-3 px-4 relative z-10 shadow-md mt-16">
