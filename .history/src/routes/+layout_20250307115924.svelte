...
<!-- Changed from p-4 to p-0 to remove default padding -->
<Navbar class="bg-[#3598db] text-white fixed w-full p-0 z-50">
	<!-- Complete custom container with minimal edge padding -->
	<div class="w-full flex justify-between items-center pl-1 pr-2 sm:pl-2 sm:pr-4 lg:px-4">
		<!-- Removed extra margin from logo -->
		<NavBrand href="/" class="flex items-center">
			<img src="/Colla-TripLogo-rem.png" class="h-20 mr-3" alt="Colla-Trip Logo" />
