...
function handleNotificationsClick(event: MouseEvent): void {
        event.preventDefault();
        // You can either:
        // 1. Open the notifications component (if it's not already global)
        // 2. Navigate to a notifications page
        // 3. Trigger a notification view in the existing Notifications component
        goto('/notifications');
    }
