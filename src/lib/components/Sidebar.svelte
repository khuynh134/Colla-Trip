...
/*
  ...
  // Function to manually handle trip creation
  async function handleManualSubmit() {
    try {
       ...
       const tripImageUrl = await fetchUnsplashImage(tripLocation) || '';
        console.log('Fetched Trip image URL:', tripImageUrl);
...
>
  <div class="space-y-8 mt-40"> 
    ...
    <div class="space-y-4">
      ...
      <!-- Trips Link -->
      <a href="/totaltripspage" class="flex items-center p-3 hover:bg-blue-600 rounded-lg transition-colors">
        <div>
